...
public class findandInsertFunction_test {
	...
	public void test() {
		...
		String testString = "public void function init (){ // do something} /n public void function myClass (){ // do something}";
		   ...
		   Logger.getLogger(findandInsertFunction_test.class.getName()).log(Level.FINE, "Current working directory : " + path);
		   ...
		   FileWriter fileWriter = null;
	        try {
	            ...
	            Logger.getLogger(findandInsertFunction_test.class.getName()).log(Level.SEVERE, null, ex);
	        } finally {
	            try {
	                fileWriter.close();
	            } catch (IOException ex) {
		...
		try {
			testBuilder.findandInsertFunction(new File(path+"/test.txt"), "function");
		} catch (IOException e) {
			Logger.getLogger(findandInsertFunction_test.class.getName()).log(Level.SEVERE, null, e);
			e.printStackTrace();
		}
